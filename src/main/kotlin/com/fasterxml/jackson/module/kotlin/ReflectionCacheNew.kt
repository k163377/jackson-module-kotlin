...
internal class ReflectionCacheNew(reflectionCacheSize: Int) {
    ...
    private fun kotlinFromJava(key: Constructor<Any>): ConstructorInstantiator<Any>? = javaConstructorToKotlin.get(key)
    ...
    private fun kotlinFromJava(key: Method): MethodInstantiator<*>? = javaMethodToKotlin.get(key)
